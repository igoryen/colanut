$( document ).ready( function(){
	...
	var leadership = [
		...
		},
		{
			"id": "rodrigo",
			"name": "Rodrigo Pinto",
			"title": "CPA, CA - Chief Financial Officer (CFO)",
			"desc": [
...

		{
			"id": "ainsley",
			"name": "Ainsley Major",
			"title": "Director, Operations and Project Management",
			"desc": [
		...
		},
		{
			"id": "karen",
			"name": "Karen Yolevski",
			"title": "LL.B., President HCS and NRS",
			"desc": [
		...
		},
		{
			"id": "robert",
			"name": "Robert Ip",
			"title": "Senior Executive Account Manager, NRS and HCS",
			"desc": [
	...
	$teammember.each( function(){
		...
		$( this ).find(".fullname").text( presult[0].name );
		$( this ).find(".jobtitle").text( presult[0].title );
